...
// Kung walang order o na-cancel na, huwag ituloy ang script
...
// Fetch all order items including notes
...
<table class="table custom-table container-fluid">
    <thead>
        <tr>
            <th>Order Item</th>
            <th>Size</th>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="d-flex justify-content-between w-100">
                ...
                <p><?php echo htmlspecialchars($$order_items['reservation_date']); ?></p>
            </div>
            <div class="d-flex justify-content-between w-100">
                <p><strong>Time:</strong></p>
                <p><?php echo htmlspecialchars($$order_items['reservation_time']); ?></p>
            </div>
            <div class="d-flex justify-content-between w-100">
...
<?php if ($order['status'] === 'payment'): ?>
            <form method="POST" enctype="multipart/form-data" class="mt-3">
                ...
                <ul>2. Upon confirmation, there will be an allotted
                time of 30 minutes to confirm payment.</ul>
                <ul>3. Failure to do so will result in cancellation of order/reservation.</ul>
                </div>
...
$(document).ready(function () {
    ...
    $('.star-rating i').on('click', function () {
        ...
        $.ajax({
            type: 'POST',
            url: 'order-track.php', // Path to the PHP file handling the request
