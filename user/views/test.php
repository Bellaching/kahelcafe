...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['register'])) {
    ...
    if (empty($errors)) {
        ...
        if ($stmt->execute()) {
            ...
            if ($mail->send()) {
                echo "<div class='alert alert-success'>Verification email sent successfully! Please check your email to verify your account.</div>";
...
<div class="container d-flex justify-content-center align-items-center min-vh-100">
    <div class="col-md-8 col-lg-6 form-container p-5">
        ...
        <div class="form-section p-4">
            ...
            <?php else: ?>
                <p class="text-success">Registration successful! Please check your email for verification.</p>
            <?php endif; ?>
        </div>
    </div>
</div>
