...
<div class="row mb-3 category-list container-fluid">
    <div class="col-12 d-flex flex-wrap justify-content-center">
        ...
        <div class="me-3">
            <a href="?" class="btn btn-light border-0 <?php echo empty($selectedCategory) ? 'active' : ''; ?>">
        ...
        <div class="me-3">
            <a href="?category=Frappe" class="btn btn-light border-0 <?php echo $selectedCategory == 'Frappe' ? 'active' : ''; ?>">
                <i class="fas fa-ice-cream me-2"></i> Frappe
            </a>
        </div>
        <div class="me-3">
