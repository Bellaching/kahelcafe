                ...
                <form action="" method="POST" id="createUserForm">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control border-0 border-bottom border-dark" id="username" name="username" placeholder="Enter a username" required>
                        </div>
                        <p class="error text-danger"></p> 
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-select border-0 border-bottom border-dark" id="roleSelect" name="role" required>
